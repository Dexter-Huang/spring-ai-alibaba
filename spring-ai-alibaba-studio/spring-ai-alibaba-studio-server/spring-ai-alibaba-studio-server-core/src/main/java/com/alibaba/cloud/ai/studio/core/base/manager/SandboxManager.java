...
public class SandboxManager {
     ...
     */
    public Result<String> executeJavaScript(String scriptContent, Map<String, Object> localVariableMap, String requestId) {
        // Validate parameters
     ...
     * @return Execution result
     */
    public Result<String> executeJava(String scriptContent, Map<String, Object> localVariableMap, String requestId) {
        // Validate parameters
        if (StringUtils.isBlank(scriptContent)) {
            log.error("Script content cannot be empty");
            return Result.error(requestId, ErrorCode.INVALID_PARAMS);
